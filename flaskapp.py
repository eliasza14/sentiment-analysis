...
# loaded_vec=TfidfVectorizer(sublinear_tf=True, encoding='utf-8',decode_error='ignore')
app = Flask(__name__)
Bootstrap(app)
...
def index():
    ...
    return render_template('reviewform2.html', form=form)
...
def results():
    ...
    render_template('reviewform.html', form=form)
